...
test('getCampaignStageCounts requests the shared campaign stage-count endpoint', async () => {
  ...
  mockFetch((url) => {
    ...
    return {
      ...
      contacts: { badge: 0, all: 0, pending: 0, running: 0, done: 0, failed: 0, no_match: 0, contacts_found: 0, emails_found: 0, is_live: false },
      validation: { badge: 0, total: 0, pending: 0, running: 0, valid: 0, invalid: 0, unknown: 0, is_live: false },
    }
  })
